...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(6.03, .0481, Math.toRadians(86.1755));
        ...
        public double linearScalar = .9656;
        public double angularScalar = -.987;
    }
