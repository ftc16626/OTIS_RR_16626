...
public class RedRightArm extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, ROT_SPEED,23, 23, 23, 23, false, 85, 11.60 , 0, 0, 2); // Go to specimen rack, rotate & arm
        encoderDrive(DRIVE_SPEED, ROT_SPEED,0, 0, 0, 0, false, 0, 5.5, 0, 0, 0.5); // Finish extension
        encoderDrive(DRIVE_SPEED, ROT_SPEED, 0, 0, 0 , 0, false, -10, -5.5, -1, 1, 1); // Hook Specimen
        encoderDrive(DRIVE_SPEED, ROT_SPEED, 0, 0, 0 , 0, false, -52, -10.5, -1, 1, 1.5); // Hook Specimen
        encoderDrive(DRIVE_SPEED, ROT_SPEED, -1.5, -1.5, -1.5 , -1.5, false, -20, 0 , 0, 0, 2.0); // Reverse
        encoderDrive((DRIVE_SPEED * .7), ROT_SPEED, 32.5, 32.5, 32.5, 32.5, true, 0, 0, 0, 0, 2.5); // Strafe right towards red sample's left side
        encoderDrive(DRIVE_SPEED, ROT_SPEED,25.5, 25.5, 25.5, 25.5, false, 0, 0, 0, 0, 2.2); // Go forward towards red sample
        encoderDrive(DRIVE_SPEED, ROT_SPEED, 13, 13, 13, 13, true, 0, 0, 0, 0, 1.5); // Strafe right to get in front of sample
        encoderDrive(DRIVE_SPEED, ROT_SPEED, -40, -40, -40, -40, false, 0, 0, 0, 0, 1.8); // Reverse sample into human player area
      ...
      //  encoderDrive((DRIVE_SPEED * 0.5), ROT_SPEED, 23.5, 23.5, 23.5, 23.5, false, 38.5, 0, 0, 0, 2.0); // Go towards specimen on wall and intake
      //  encoderDrive((DRIVE_SPEED * 0.4), ROT_SPEED, 0, 0, 0, 0, false, 0, 7.0, -1, 1, 1.7); // Go towards specimen on wall and intake
      //  encoderDrive((DRIVE_SPEED * 0.4), ROT_SPEED, 0, 0, 0, 0, false, 18, 1, 0, 0, 1); // Rotate to pick specimen off wall
      //  encoderDrive(DRIVE_SPEED, ROT_SPEED, -17, -17, -17, -17, false, 25, 3, -1, 1, 1.5); // Reverse from wall
      //  encoderDrive(DRIVE_SPEED, ROT_SPEED,60, 60, 60, 60, true, 0, 0, 0, 0, 2.8); // Strafe right towards specimen rack
      //  encoderDrive(DRIVE_SPEED, ROT_SPEED, 45, 45, -45, -45, false, 0, 0, 0, 0, 2.0); // Turn 180 degrees (now facing specimen rack)
      //  encoderDrive(DRIVE_SPEED, ROT_SPEED, 0, 0, 0, 0, false, 4, 4, -1, 1, .5); // Extend and rotate arm
      //  encoderDrive(DRIVE_SPEED, ROT_SPEED, 0, 0, 0, 0, false, -45, -10, -1, 1, .5); // Hook specimen to rack
